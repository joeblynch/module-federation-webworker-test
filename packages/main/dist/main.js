...
/*!*********************************************************!*\
  !*** external "remote@//localhost:3002/remoteEntry.js" ***!
  \*********************************************************/
...
/******/ 	(() => {
/******/ 		var chunkMapping = {
/******/ 			"webpack_container_remote_remote_remote-logger": [
/******/ 				"webpack/container/remote/remote/remote-logger"
/******/ 			]
/******/ 		};
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _local_logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./local-logger */ "./src/local-logger.js");
...
(async function main() {
  ...
  (0,_local_logger__WEBPACK_IMPORTED_MODULE_0__.localLogger)();

  // import a remote module, and log from it
  const { remoteLogger } = await __webpack_require__.e(/*! import() */ "webpack_container_remote_remote_remote-logger").then(__webpack_require__.t.bind(__webpack_require__, /*! remote/remote-logger */ "webpack/container/remote/remote/remote-logger", 23));
  remoteLogger();
})();
})();
